...
| -------------------------------------------------------- | ---------------------------------------------------- | --------------------------------------------------- |
| **Any non-trivial task**                                 | `.github/context/agent-decisions.md`                 | `.github/context/anti-patterns-critical.context.md` |
...
| **Architectural question / ADR**                         | `docs/decisions.md`                                  | `docs/README.md`                                    |
| **Why a pattern was chosen**                             | `docs/decisions.md`                                  | —                                                   |
| **Prompt says code is inconsistent / mismatches a rule** | `docs/decisions.md`                                  | `anti-patterns-critical.context.md` rule 11         |
| **What not to do / anti-patterns**                       | `.github/context/anti-patterns-critical.context.md`  | `agent-decisions.md`                                |
| **Agent misbehaved / correction needed**                 | `.github/context/agent-decisions.md`                 | —                                                   |
...
| `.github/context/agent-decisions.md`                | Append-only log of agent corrections                  | After every meaningful agent correction              |
...
| `docs/decisions.md`                                 | Lightweight ADRs (newest-first)                       | When a significant architectural decision is made    |
| `docs/README.md`                                    | Human-readable docs index                             | When decisions.md gains new entries                  |
